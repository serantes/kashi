...
PlasmaCore.DataSource {
    ...
    property string asText: getMetadata("xesam:asText", 'No lyrics found.')
    property bool canGoPrevious: getHasData() && data["@multiplex"]["CanControl"]
    property bool canGoNext: getHasData() && data["@multiplex"]["CanControl"]
